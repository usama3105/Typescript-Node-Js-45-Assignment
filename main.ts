...
let stri: string = "hello world";
let upperCaseStri: string = stri.toUpperCase();

console.log(upperCaseStri);

 let lowerCaseStri: String = stri.toLowerCase();
console.log(lowerCaseStri);

function ToTitleCase(stri:string):string{
    return stri.toLowerCase().replace(/\b\w/g, function(char){
    return char.toUpperCase();
    })
}
let sentence :string = stri;
let TitleCase:string=ToTitleCase(sentence);
...
let Quote:string="Think 100 times before you take a decision, But once that decision is taken, stand by it as one man";
let message2:string= famousperson+" Said: "+Quote;
...
let names: string[]=["Usama","Ali","Dayyan","Adnan","Zubair"]
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
console.log("");
let names2: string[]=["Usama","Ali","Dayyan","Adnan","Zubair"];
...
console.log("");
let vichel:string []=["Honda 125","Honda Civic","Suzuki 150","Corolla"];
...
console.log("");
let guest:string [] = ["usama", "sabir", "babar"];
...
console.log("");
let GuestArray:string[]=["Usama","Sabir","Babar","Asad"];
let CantInvite:string ="Usama";
...
console.log("");
let guestarray:string[]=["Alishba","usama","sabir","Ali"];
let cantinvite:string="Alishba";
let newguest:string="Khan";
guestarray[guestarray.indexOf(cantinvite)]=newguest;
console.log(guestarray);
guestarray.map((items)=>
console.log("dear,"+items+" I have a Bigger Dinner Plan"));

// TASK 17
console.log("");
console.log("TASK 17 'Shrinking Guest List'");
console.log("");
let guest01:string[]=["ali","Asad","hassan","Kamran","kashif"];
...
//guest final
let guest02:string[]=["usama","ayan","sabir"]
guest02.pop();
guest02.pop();
...
let countryForVisit:string[]=["Pakistan","Tokyo","China","Africa","Canada"];
...
console.log("");
let guest2:string [] = ["usama", "sabir", "babar"];
...
console.log("");
let country:string [] = ["Pakistan","China","Afghanistan","Dubai"];
console.log("List of Country");
console.log(country);

let languages:string[]=["Urdu","English","Spanish","Chainese"]
...
console.log("");
let person:{name:string, fname:string,age:number}={name:"Usama",fname:"Usama Murtaza",age:21};
console.log(person);
...
let AlineColor2:string="Red";
if(AlineColor2=="Red"){
    console.log("No Output");
}

let AlineColor3:string="Green";
if(AlineColor2=="Red"){
    console.log("No Output");
}
...
console.log("");
let FavourateFruit:string[]=["Banana","Apple","Graphs","Gava","Orange","Peach","Berry","Tomato"]
...
let Users:string[]=["Admin","Usama","Sabir","Ali","Saad"];
...
let Users2:string[]=["Admin","Usama","Sabir","Ali","Saad"];
if(Users2.length==0){
...
let CurrentUsers:string[]=["Admin","Usama","Sabir","Ali","Saad"];
let NewUsers:string[]=["Admin","Asad","Sabir","Saleem","Saad"];
...
let FavouratePizza:string[]=["Pepperoni","Chicken","Veg"];
...
let FavourateAnimal:string[]=["Cat","Dog","Mouse"];
...
function makeShirt(size:string, text:string, neckSize:number){
...
function makeShirt2(size2:string = 'Large ', text2:string=' I love Typescript'):void{
...
function DescribeCity(city:string, country2:string="Pakistan"):void{
...
function DescribeCity2(city3:string, country3:string="Pakistan"):String{
...
function ShowMagics(Magicians: string[]): void {
    for (const magician of Magicians) {
        console.log(magician.charAt(0).toUpperCase() + magician.slice(1));
    }
}
const magician:string[]=["Ali","Hamza","Sabir"];
ShowMagics(magician);
...
function makeGreate(magician2: string[]): void {
    for (let i = 0; i < magician2.length; i++) {
        magician2[i] = magician2[i] + " The Great magician";
    }
}

const magician3: string[] = ["Ali", "Hamza", "Sabir"];
...
const originalMagicians: string[] = ["Ali", "Hamza", "Sabir"];
